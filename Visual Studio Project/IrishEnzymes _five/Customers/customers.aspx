<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="customers.aspx.vb" Inherits="Customers_customers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <br />
        <asp:Panel ID="CustomersPanel1" runat="server" Height="50px" Width="521px" 
        style="margin-right: 9px">
            <p>Customers are listed alphabetically by Surname</p>
    ...
    <asp:DetailsView ID="DetailsView1" runat="server" AllowPaging="True" 
        ...
        DataSourceID="AccessDataSource1" ForeColor="" GridLines="None" 
        Height="58px" Width="424px" CssClass="marginLeft">
            ...
            <asp:TemplateField ShowHeader="False">
                ...
                <ItemTemplate>
                    ...
                    <asp:ConfirmButtonExtender ID="Button3_ConfirmButtonExtender" runat="server" 
                        ConfirmText="Are You Sure?" Enabled="True" TargetControlID="Button3">
                    </asp:ConfirmButtonExtender>
                </ItemTemplate>
            </asp:TemplateField>
        </Fields>
    ...
    <asp:DragPanelExtender ID="DetailsView1_DragPanelExtender" runat="server" 
        DragHandleID="DetailsView1" Enabled="True" TargetControlID="DetailsView1">
