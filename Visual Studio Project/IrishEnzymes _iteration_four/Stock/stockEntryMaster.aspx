   ...
   <br />
    <br />
     <br />
        ...
        CellPadding="4" ForeColor="#333333" Height="216px" Width="406px" 
            CssClass="marginLeft">
            <EditItemTemplate>
                StockID:
            ...
            <InsertItemTemplate>
                ...
                <asp:TextBox ID="StockIDTextBox" runat="server" Text='<%# Bind("StockID") %>' 
                    style="margin-left: 38px" Width="215px" />
                <br />
                Description:
                <asp:TextBox ID="DescriptionTextBox" runat="server" 
                ...
                Price:&nbsp;
                <asp:TextBox ID="PriceTextBox" runat="server" Text='<%# Bind("Price") %>' 
                    style="margin-left: 53px" Width="215px" />
                <br />
                ...
                &nbsp;<br />SupplierID:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox 
                    ...
                    Text='<%# Bind("SupplierID") %>' Width="215px" />
                &nbsp;<br />
