<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false"
    CodeFile="masterDetails.aspx.vb" Inherits="Customers_masterDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div>
        ...
        <asp:Panel ID="Panel1" runat="server" Height="32px" Width="521px">
            Press Select to See the Order Details of a Customer
        </asp:Panel>
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            ForeColor="#333333" GridLines="None" CssClass="marginLeftTwo" Height="324px"
            PageSize="8" Width="537px">
