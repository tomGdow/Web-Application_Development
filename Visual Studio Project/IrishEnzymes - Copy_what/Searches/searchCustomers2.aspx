...
<div>
        ...
        <asp:Panel ID="Panel1" runat="server" Height="32px" Width="521px">
            Search Customers by Firstname (eg Thomas) or by Surname (eg Dowling)<br /> </asp:Panel>
            
            <asp:Panel ID="Panel3" runat="server" Height="32px" Width="521px">
            Click on Select in Search Results to See Customer Order Details<br /> </asp:Panel>
            <br />
...
<br />
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
            ...
            GridLines="None" CssClass="marginLeftTwo">
