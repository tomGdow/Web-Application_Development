<%@ Page Language="VB" AutoEventWireup="false" CodeFile="meOrdersPartOne.aspx.vb" Inherits="meOrdersPartOne" %>
...
></asp:AutoCompleteExtender>
        ...
        <asp:AccessDataSource ID="AccessDataSource1" runat="server" 
            ...
            SelectCommand="SELECT * FROM Orders WHERE (Item = ?) Or (CustomerID = ?)">
            <SelectParameters>
