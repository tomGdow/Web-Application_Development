<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" CodeFile="adoSuppliers.aspx.vb" Inherits="Suppliers_adoSuppliers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
 ...
 <br />
        <asp:Panel ID="Panel1" runat="server" Height="32px" Width="521px">
            Supplier details as visualized with an ADO.net connection to the Suppliers Table </asp:Panel>
 <br />

<asp:DataGrid id="dgResults" runat="server" CellPadding="4" ForeColor="#333333" 
    GridLines="None" CssClass="marginLeft" >
